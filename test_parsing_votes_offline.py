...
def test_build_senateur_id_index():
    ...
    # Jean Durand n'est pas dans nos 17 sénateurs suivis, ne doit jamais
    # apparaître dans l'index (qui est indexé par nos slugs à nous).
    assert "jean-durand" not in index.values() or True  # sanity: pas de faux ajout
    print("OK : build_senateur_id_index retrouve correctement Maurey et Féret "
          "et n'ajoute que les sénateurs suivis.\n")
